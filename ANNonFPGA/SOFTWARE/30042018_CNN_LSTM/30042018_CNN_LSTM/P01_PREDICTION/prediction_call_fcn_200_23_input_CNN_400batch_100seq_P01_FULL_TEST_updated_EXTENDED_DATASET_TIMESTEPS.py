...
for m in range(0,dataset_size-10):
...
for i in range(0,seq_number):
 for j in range(0,timesteps):
  ...
  #print(initial_time+(i*batch_size_new*timesteps)+j*batch_size_new)
  #print(initial_time+(i*batch_size_new*timesteps)+((j+1)*batch_size_new))
  X_new[seq_number*23+i,j,:,0:batch_size_new,0] =  X[file-1,0,0,0:input_size_new,initial:final,0]    
...
Y_new[seq_number*23:seq_number*23+seq_number,0] = 1
...
model.fit(X_new,Y_new, epochs=25)
#Trying model
yhat = model.predict(X_new, verbose=0)
file1 = open("CNN_LSTM_dataset_train_100seq_NO_FILTER.txt", 'ab')
...
with open("final_data_train_50seq_NO_FILTER_EXTENDED_DATASET.txt", 'w') as file_1:
 for i in range(0,a):
    #file_1.write(' '+str(i)+' ')
...
file2 = open("CNN_LSTM_400batch_50_ouputs_50seq_NO_FILTER_EXTENDED_DATASET.txt", 'ab')
...
with open("final_data_100seq_NO_FILTER.txt", 'w') as file_1:
 for i in range(0,a):
    #file_1.write(' '+str(i)+' ')
...
output_count(seq_number, test_files, yhat_test, '_seq_NO_FILTER_epochs_EXTENDED_DATASET_TESTS')
