...
file1 = open("CNN_LSTM_dataset_train_100seq_FILTER.txt", 'ab')
...
with open("final_data_train_100seq_FILTER.txt", 'w') as file_1:
 for i in range(0,a):
    #file_1.write(' '+str(i)+' ')
...
file2 = open("CNN_LSTM_400batch_50_ouputs_100seq_FILTER.txt", 'ab')
...
with open("final_data_FILTER.txt", 'w') as file_1:
 for i in range(0,a):
    #file_1.write(' '+str(i)+' ')
...
output_count(seq_number, test_files, yhat_test, 'updated_100seq_FILTER_20epochs')
