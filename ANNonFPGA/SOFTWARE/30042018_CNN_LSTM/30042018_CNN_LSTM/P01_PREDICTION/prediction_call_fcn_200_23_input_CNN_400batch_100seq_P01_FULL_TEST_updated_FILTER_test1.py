...
with open("final_data_train_100seq_NO_FILTER.txt", 'w') as file_1:
 for i in range(0,a):
    #file_1.write(' '+str(i)+' ')
...
file2 = open("CNN_LSTM_400batch_50_ouputs_100seq_NO_FILTER.txt", 'ab')
...
output_count(seq_number, test_files, yhat_test, '_50seq_FILTER_25epochs_1ConvLayer')
