#modification for cross validation 
...
model.fit(X_new,Y_new, epochs=39)
#Trying model
...
file2 = open("CNN_LSTM_400batch_50_ouputs_50seq_NO_FILTER_EXTENDED_DATASET_gru.txt", 'ab')
...
with open("final_data_100seq_NO_FILTER_gru.txt", 'w') as file_1:
 for i in range(0,a):
    #file_1.write(' '+str(i)+' ')
...
output_count(seq_number, test_files, yhat_test, '_50seq_NO_FILTER_25epochs_EXTENDED_DATASET_50LSTM_GRU')
