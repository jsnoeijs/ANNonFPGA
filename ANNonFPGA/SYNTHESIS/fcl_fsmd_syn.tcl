...
#
set HDL_FILES [list \
   HDL/ANNonFPGA/RTL/fcunit_ppl.vhd \
...
set DESIGN_ELAB   "${ENTITY_NAME}_nbits${NBITS}_nbsamples${NB_SAMPLES}_in${INPUT_SIZE}_out${OUTPUT_SIZE}"
...
elaborate ${ENTITY_NAME} -architecture ${ARCH_NAME} \
                         -parameters "NBITS = ${NBITS}, NB_SAMPLES = ${NB_SAMPLES}, INPUT_SIZE = ${INPUT_SIZE}, OUTPUT_SIZE = ${OUTPUT_SIZE}"
